			...
			<form action="forgot_process.php" method="POST">
				<div class="login_form">
					<div class="form-group">
						<img src="../images/Op2.png" alt="Healthy Farm Crops" class="img-fluid logo">
						<?php if(isset($_GET['err'])){
						  $err = $_GET['err'];
						   ...
						   if(isset($_GET['servererr'])){
						  	   echo "<p class='errmsg'><br>Your link is processing.Please check your link after one hour..\n Thank You..</p>";
						  }
						    // if other issues
