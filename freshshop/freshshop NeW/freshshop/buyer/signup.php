...
<head>
	...
	<title>BUYER Signup - Healthy Farm Crops</title>
...
<body style ="background-image: url(../images/back2.jpg);">
	...
	<div class="col-sm-4">
			 ...
			 <?php
                     ...
                     if(!isset($error)){
                     	...
                     	$password = password_hash($password, PASSWORD_BCRYPT,$options);
                     		...
                     		$result = mysqli_query($dbc,"INSERT into buyer(id,fname,lname,	username,email,address,contactno,password )
		...
		<!--register form start-->
		<div class=" signup_form col-sm-4 mb-0">
