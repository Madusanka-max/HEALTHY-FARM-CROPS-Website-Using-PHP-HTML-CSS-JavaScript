...
if(isset($_POST['subforgot'])){
	...
	if($result)
	{
		$findresult = mysqli_query($dbc,"SELECT * FROM buyer WHERE (username='$login' OR email = 
			'$login')");
    ...
    try {
        ...
        $mail->Body    = "This your password reset link.<p><a href='http://localhost/freshshop%20NeW/freshshop/buyer/password-reset.php'>Link</a></p> Click to reset your password....";
