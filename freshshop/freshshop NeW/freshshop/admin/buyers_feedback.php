   ...
   <!--start header top-->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item "><a class="nav-link" href="BUYER_IN_AdminPANEL.php">Buyers</a></li> 
                        ...
                        <li class="nav-item active"><a class="nav-link" href="buyers">Feedback</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="text-align: center;">Seller's Details</h2>                   
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid"> 
    <div class="table-responsive">
      <h2 class="text-center">Details of Sellers</h2>
      ...
      <tbody>
          ...
          ?>
            <tr>
                ...
                <td><button type="button" class="btn btn-info" href="adminSend.php">Send Message</button></td>
