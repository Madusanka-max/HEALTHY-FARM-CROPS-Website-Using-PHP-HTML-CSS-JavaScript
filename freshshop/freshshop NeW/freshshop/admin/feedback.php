...
<div class="container-fluid"> 
    <div class="table-responsive">
      <h2 class="text-center">All Users Feedback Details</h2>
      ...
      <tbody>
          ...
          ?>
            <tr>
                ...
                <td><button type="submit" class="btn btn-info value="send" name="submit"><a href="adminSend.php">Send Message</a></button></td>
